...
public class AppOrdenAlternativo4 {
	public static void main(String[] args) {
		//clase anonima
		Comparator<Usuario> compararUsuarioFechaDesc = new Comparator<Usuario>() {

			public int compare(Usuario usuario1, Usuario usuario2) {

				return usuario2.getFechaCreacion().compareTo(usuario1.getFechaCreacion());
			}
		};

		Set<Usuario> usuarios = new TreeSet<>(compararUsuarioFechaDesc);// puedo tomar la fomra de cualquier de mis
																		// hijos
